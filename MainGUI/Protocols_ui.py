...
class Ui_protocols(object):
    def setupUi(self, protocols):
        ...
        self.listWidget.setGeometry(QRect(56, 270, 901, 261))
        self.label_4 = QLabel(protocols)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(356, 240, 101, 16))
        self.addStage = QPushButton(protocols)
        self.addStage.setObjectName(u"addStage")
        self.addStage.setGeometry(QRect(1010, 210, 75, 24))
        ...
        self.layoutWidget.setGeometry(QRect(58, 83, 1031, 118))
        ...
        self.gridLayout.addWidget(self.groupsNumbers, 0, 10, 1, 1)

        self.stim_time = QLineEdit(self.layoutWidget)
        self.stim_time.setObjectName(u"stim_time")

        self.gridLayout.addWidget(self.stim_time, 2, 11, 1, 1)
        ...
        self.use_roi = QCheckBox(self.layoutWidget)
        self.use_roi.setObjectName(u"use_roi")

        self.gridLayout.addWidget(self.use_roi, 2, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_18, 0, 13, 1, 1)

        self.record_raw = QCheckBox(self.layoutWidget)
        self.record_raw.setObjectName(u"record_raw")

        self.gridLayout.addWidget(self.record_raw, 2, 13, 1, 1)

        self.saveProtocol = QPushButton(protocols)
        self.saveProtocol.setObjectName(u"saveProtocol")
        self.saveProtocol.setGeometry(QRect(706, 540, 91, 24))
...
"}")
        ...
        self.removeStage.setGeometry(QRect(56, 540, 75, 24))
        self.closeWindow = QPushButton(protocols)
        self.closeWindow.setObjectName(u"closeWindow")
        self.closeWindow.setGeometry(QRect(840, 540, 91, 24))
...
" groups", None))
        ...
        self.label_5.setText(QCoreApplication.translate("protocols", u"RECORD", None))
        self.record_stage.setText("")
...
" output group", None))
        ...
        self.label_17.setText(QCoreApplication.translate("protocols", u"Use users \n"
" ROI", None))
...
"", None))
        ...
        self.jitter.setText("")
        self.use_roi.setText("")
        self.label_8.setText(QCoreApplication.translate("protocols", u"Stimulation \n"
" time (min)", None))
        self.label_18.setText(QCoreApplication.translate("protocols", u"Record \n"
" raw data", None))
        self.record_raw.setText("")
