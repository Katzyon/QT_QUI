...
class QFont(Shiboken.Object):
    ...
    def family(self) -> str: ...
    def featureTags(self) -> List[int]: ...
    def featureValue(self, tag: int) -> int: ...
    ...
    def isFeatureSet(self, tag: int) -> bool: ...
    ...
    @overload
    def setFeature(self, feature: bytes, value: int) -> None: ...
    @overload
    def setFeature(self, tag: int, value: int) -> None: ...
    ...
    @staticmethod
    def stringToTag(tagString: bytes) -> int: ...
    ...
    @staticmethod
    def tagToString(tag: int) -> PySide6.QtCore.QByteArray: ...
    def toString(self) -> str: ...
    def underline(self) -> bool: ...
    @overload
    def unsetFeature(self, feature: bytes) -> None: ...
    @overload
    def unsetFeature(self, tag: int) -> None: ...
...
class QImage(PySide6.QtGui.QPaintDevice):
    ...
    def toHICON(self, mask: Union[PySide6.QtGui.QImage, str] = ...) -> int: ...
    @staticmethod
...
class QTextFormat(Shiboken.Object):
    ...
    class Property(enum.IntEnum):
        ...
        ListStart                : QTextFormat.Property = ... # 0x3004
